...
local function generate_turret(magazine, damage)
  local turret =
  {
    ...
    sprite =
    {
      filename = "__SteamPowered__/graphics/equipment/personal-turret-equipment/" .. magazine .. ".png",
      width = 128,
      height = 128,
      priority = "medium"
    },
...
data:extend(
{
    ...
    sprite = {
      filename = "__SteamPowered__/graphics/equipment/portable-generator-equipment.png",
      width = 224,
      height = 224,
      priority = "medium"
		},
