...
with (technology["mining-productivity-1"], 
  {
    icon = "__SteamPowered__/graphics/technology/mining-productivity.png",
    icon_size = 128,
...
data:extend{
  {
    type = "item",
    name = "gyroscope",
    icon = "__SteamPowered__/graphics/icons/gyroscope.png",
    icon_size = 32,
  ...
  },
  {
    type = "technology",
    name = "gyroscope",
    icon = "__SteamPowered__/graphics/technology/gyroscope.png",
    icon_size = 224,
    effects =
    {
      {
