...
new_miner_item.icon = new_miner_item.icon:gsub("__base__","__SteamPowered__")
...
local f_ani_s = function(animations,faces) for _,face in pairs(faces) do 
	...
	if string.find(layer.filename, "shadow", 1, true) then
  	...
  	layer.filename = layer.filename:gsub("__base__","__SteamPowered__")
  	layer.hr_version.filename = layer.hr_version.filename:gsub("__base__","__SteamPowered__")
  end
end end
...
data:extend{
	{
	  type = "item",
		...
		icon = "__SteamPowered__/graphics/icons/mip/dirty-uranium-ore.png",
		icon_size = 64,
		pictures =
    {
      { size = 64, filename = "__SteamPowered__/graphics/icons/mip/dirty-uranium-ore.png",   scale = 0.25, mipmap_count = 4 },
      { size = 64, filename = "__SteamPowered__/graphics/icons/mip/dirty-uranium-ore-1.png", scale = 0.25, mipmap_count = 4 },
      { size = 64, filename = "__SteamPowered__/graphics/icons/mip/dirty-uranium-ore-2.png", scale = 0.25, mipmap_count = 4 },
      { size = 64, filename = "__SteamPowered__/graphics/icons/mip/dirty-uranium-ore-3.png", scale = 0.25, mipmap_count = 4 }
    },
	...
	},
	{
	  type = "recipe",
	  name = "clear-uranium",
		icon = "__SteamPowered__/graphics/icons/clear-uranium.png",
		icon_size = 32,
		enabled = false,
