...
data:extend{
  {
    ...
    name = "gearing",
    icon_size = 128,
    icon = "__SteamPowered__/graphics/technology/gearing.png",
    effects =
    {
      {
        type = "unlock-recipe",
  ...
  },
  {
    ...
    name = "gearing-2",
    icon_size = 128,
    icon = "__SteamPowered__/graphics/technology/gearing-2.png",
    effects =
    {
      {
        type = "unlock-recipe",
...
with(data.raw.item["iron-gear-wheel"],
  {
    ...
    icon = "__SteamPowered__/graphics/icons/iron-gear-set.png",
    icon_size = 32,
  }
)
...
data:extend{
  {
    type = "item",
    name = "simple-gear-box",
    icon = "__SteamPowered__/graphics/icons/gearing.png",
    icon_size = 32,
  ...
  },
  {
    type = "item",
    name = "advanced-gear-box",
    icon = "__SteamPowered__/graphics/icons/gearing-2.png",
    icon_size = 32,
    subgroup = "intermediate-product",
    order = "d-ab",
    stack_size = 50
